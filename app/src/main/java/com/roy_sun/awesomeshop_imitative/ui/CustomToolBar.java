package com.roy_sun.awesomeshop_imitative.ui;
...
public class CustomToolBar extends Toolbar {
    ...
    public CustomToolBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            final TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, R.styleable.CNiaoToolBar, defStyleAttr, 0);
    ...
    public void showSearchView() {
        ...
        if (mSearchView != null) mSearchView.setVisibility(VISIBLE);

    }


    public void hideSearchView() {
        if (mSearchView != null) mSearchView.setVisibility(GONE);
    }

    public void showTitleView() {
        if (mTextTitle != null) mTextTitle.setVisibility(VISIBLE);
    }


    public void hideTitleView() {
        if (mTextTitle != null) mTextTitle.setVisibility(GONE);
